                ...
                <div class="board__inner">
                    <div class="boardRcont__wrap">
                        <?php
                            ...
                            $sql = "SELECT b.boardTitle, m.youID, b.boardView, b.boardContents, b.boardRegTime, b.boardImgFile, b.memberID, b.boardLike FROM TPBoardR b JOIN TPmyMember m ON(m.memberID = b.memberID) WHERE b.boardID = {$boardID}";
